...
include "../action/fetch_users.php";
...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
            ...
            <li><a href="../admin/users.php" class="active"><i class='bx bxs-user-account icon' ></i> Users</a></li>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        $userRole = htmlspecialchars($row['role']); // Assuming role column exists
                                        ...
                                        if ($userRole != 2) {
                                            echo "<a href='../action/updateRole.php?action=makeAdmin&id={$userId}' class='btn'>Make Admin</a>";
                                        } else {
                                            echo "<a href='../action/updateRole.php?action=removeAdmin&id={$userId}' class='btn'>Remove Admin</a>";
                                        }
